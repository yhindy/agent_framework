...
**WARNING: Keep nesting shallow.**

- Maximum recommended depth: 1 level (parent Super Minion -> child Super Minion)
- Each nesting adds ~2,500 tokens overhead
- For deeply nested work, prefer sequential tasks over nested Super Minions
- **Do NOT spawn a Super Minion subagent from within a Super Minion subagent**

If your sub-feature needs its own sub-features, break them into sequential phases instead.
